...
public class stateTwo implements CoursePlannerStateI
{
    ...
    public stateTwo(Student studentIn)
	{
	...
	public void registerCourse()
	{
        ...
        System.out.println("In State Two register course");
        ...
        //{
        	if(waitedList.size()>0)
        	{
        		...
        		System.out.println("State2 on register function 1111111");
        		checkWaitList = true;
        		for(int i = 0; i<waitedList.size(); i++)
        		{
        			System.out.println("State2: waitlist loop, waited item: " + waitedList.get(i));
        			System.out.println("State2: waitlist loop, the pre req course for waited item: " + checkPreRequisitCourse(waitedList.get(i)));
            ...
            if(waitedList.size()<0 || !courseTaken)
       		{
       			System.out.println("State2 on register function 2222222");
            	...
            	{
       				System.out.println("State2: requestList loop, requestd item: " + requestedCourseList.get(i));
       				System.out.println("State2: requestList loop, the pre req course for requested item: " + checkPreRequisitCourse(requestedCourseList.get(i)));
       				...
       				{
       					System.out.println("State2: requestedlist, No pre-requisit, the current semestercontains pre-req? "+ currentSemCourses.contains(checkPreRequisitCourse(requestedCourseList.get(i))));
       				...
       				{
       					System.out.println("State2: the student should wait for the course: " + requestedCourseList.get(i));
        ...
        System.out.println("State2: After checking everything: the result for this round: ");
      ...
      student.setRequestedCourses(requestedCourseList);
       ...
       if(courseTaken == true)
       {
       	  ...
       	  System.out.println("State2: the taken course " + recentCourse + " and its group is: " + courseGroup );
       	  student.updateGroupCourseNumbers(courseGroup);
       	  int stateNum = student.checkState();
       	  System.out.println("State2: the new state is: "+ (stateNum+1));
	...
	{
		System.out.println("State 2: The registered Courses: ");
	...
	{
		System.out.println("State 2: The waited List: ");
	...
	{
		System.out.println("State 2: The requested List: ");
	...
	{
		System.out.println("State 2: The currentSemCourses: ");
