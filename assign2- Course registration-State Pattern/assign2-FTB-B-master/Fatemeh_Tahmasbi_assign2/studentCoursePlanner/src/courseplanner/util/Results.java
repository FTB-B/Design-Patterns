    ...
    FileWriter ResultsFileWriter = null;
		...
		try{
          if(!RegisterResults.exists()){
            ...
            {
    			System.err.println("Exception in Writing the Registration File. Couldn't write in the output.txt");
			}       
			finally 
			{
  			 try 
  			 ...
  			 {
  			 	System.err.println("Exception in Writing the Registration File. Can't close the file");
  			 }
			}
